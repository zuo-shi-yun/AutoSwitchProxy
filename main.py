...
from plugins.my_plugin.utils.clash import Clash
...
class AutoSwitchProxy(Plugin):
    ...
    def handle_normal_msg(self, event: EventContext, **kwargs):
        Clash.global_mode()  # 更改cfw模式——global

    @on(SessionExpired)
    def handle_session_expired(self, event: EventContext, **kwargs):
